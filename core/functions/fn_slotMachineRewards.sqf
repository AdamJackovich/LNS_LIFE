...
{
   if(_slotType == 0)then {_ret = 3000;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 6000;};   //average joe's
   if(_slotType == 2)then {_ret = 12000;};  //high roller's
};
...
{
   if(_slotType == 0)then {_ret = 200;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 400;};   //average joe's
   if(_slotType == 2)then {_ret = 800;};  //high roller's
};

if(_idxA == 0 && _idxB == 0 && _idxC == 0)then//                      (LEAF , LEAF , LEAF)
{
   if(_slotType == 0)then {_ret = 100;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 200;};   //average joe's
   if(_slotType == 2)then {_ret = 400;};  //high roller's
};


if((_idxA == 8 && _idxB == 8 && _idxC != 8) or (_idxA == 8 && _idxB != 8 && _idxC == 8) or (_idxA != 8 && _idxB == 8 && _idxC == 8))then // 2 Bars + Any     
{
   if(_slotType == 0)then {_ret = 80;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 160;};   //average joe's
   if(_slotType == 2)then {_ret = 320;};  //high roller's
};

if((_idxA == 7 && _idxB == 7 && _idxC != 7) or (_idxA == 7 && _idxB != 7 && _idxC == 7) or (_idxA != 7 && _idxB == 7 && _idxC == 7))then // 2 Sevens + Any     
{
   if(_slotType == 0)then {_ret = 40;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 80;};   //average joe's
   if(_slotType == 2)then {_ret = 160;};  //high roller's
};

if((_idxA == 6 && _idxB == 6 && _idxC != 6) or (_idxA == 6 && _idxB != 6 && _idxC == 6) or (_idxA != 6 && _idxB == 6 && _idxC == 6))then // 2 Sevens + Any     
{
   if(_slotType == 0)then {_ret = 20;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 40;};   //average joe's
   if(_slotType == 2)then {_ret = 80;};  //high roller's
};

if((_idxA == 5 && _idxB == 5 && _idxC != 5) or (_idxA == 5 && _idxB != 5 && _idxC == 5) or (_idxA != 5 && _idxB == 5 && _idxC == 5))then // 2 Sevens + Any     
{
   if(_slotType == 0)then {_ret = 10;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 20;};   //average joe's
   if(_slotType == 2)then {_ret = 40;};  //high roller's
};

if((_idxA == 4 && _idxB == 4 && _idxC != 4) or (_idxA == 4 && _idxB != 4 && _idxC == 4) or (_idxA != 4 && _idxB == 4 && _idxC == 4))then // 2 Sevens + Any     
{
   if(_slotType == 0)then {_ret = 90;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 180;};   //average joe's
   if(_slotType == 2)then {_ret = 360;};  //high roller's
};
...
{
   if(_slotType == 0)then {_ret = 70;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 140;};   //average joe's
   if(_slotType == 2)then {_ret = 280;};  //high roller's
};

if((_idxA == 1 && _idxB == 1 && _idxC != 1) or (_idxA == 1 && _idxB != 1 && _idxC == 1) or (_idxA != 1 && _idxB == 1 && _idxC == 1))then // 2 Plums + Any     
{
   if(_slotType == 0)then {_ret = 60;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 120;};   //average joe's
   if(_slotType == 2)then {_ret = 240;};  //high roller's
};

if((_idxA == 0 && _idxB == 0 && _idxC != 0) or (_idxA == 0 && _idxB != 0 && _idxC == 0) or (_idxA != 0 && _idxB == 0 && _idxC == 0))then // 2 Cherrys + Any     
{
   if(_slotType == 0)then {_ret = 50;};   //penny snatcher's
   if(_slotType == 1)then {_ret = 100;};   //average joe's
   if(_slotType == 2)then {_ret = 200;};  //high roller's
};
