...
_object = _this Select 0;  //Setup the progress bar
_cpRate = 0.0045;
disableSerialization;
_title = "Breaking out prisoner";
life_action_inUse = true;//Setup the progress bar
disableSerialization;_title = "Breaking out prisoner";
5 cutRsc ["life_progress","PLAIN"];
_ui = uiNamespace getVariable "life_progress";
_progressBar = _ui displayCtrl 38201;
_titleText = _ui displayCtrl 38202;
_titleText ctrlSetText format["%2 (1%1)...","%",_title];
_progressBar progressSetPosition 0.01;_cP = 0.01;
while {true} do{
	...
	if(life_interrupted) exitWith {};};//Kill the UI display and check for various states
	5 cutText ["","PLAIN"];player playActionNow "stop";
