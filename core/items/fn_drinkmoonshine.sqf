/*File:
 ...
 "radialBlur" ppEffectEnable true;//"wetDistortion";
 ppEffectEnable true;
 enableCamShake true;
 player setVariable["inDrink",true,true];for "_i" from 0 to 89 do{    if(life_drink > 0.15) then {
 //"wetDistortion";
 ppEffectAdjust [random 5];
 ...
 //titleText
 [localize "STR_MISC_DrunkBlackOut","BLACK IN"];
 sleep 15;
 ...
 //Stop effectsplayer
 setVariable["inDrink",false,true];
