/*	File: fn_sequestra.sqf
	...
	Description:	Rimuove equipaggiamento illegale dalla unit*/
	...
	if(_headgear != "") then {	if(_headgear in life_illegal_stuffs) then {
	...
	hint format["%1 He has removed all of the illegal items.",name _cop];
