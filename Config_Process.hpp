...
class ProcessAction {
    ...
    class whiskey {
       MaterialsReq[] = {{"raw_yeast",2},{"raw_rye",2}};
    ...
    class moonshine {
       MaterialsReq[] = {{"raw_yeast",2},{"mash",2}};
    ...
    class mash {
       MaterialsReq[] = {{"cornmeal",2},{"waterBottle",2}};
       MaterialsGive[] = {{"mash",1}};
       Text = "STR_Process_Mash";
       ScrollText = "Process Mash";
       NoLicenseCost = 4000;
    };
	
	class lsd {
       MaterialsReq[] = {{"raw_frogs",2},{"phosphorus",2}};
       MaterialsGive[] = {{"lsd",1}};
	...
	class beer {
       MaterialsReq[] = {{"hops",2},{"yeast",2}};
       MaterialsGive[] = {{"beer",1}};
       Text = "STR_Process_beer";
       ScrollText = "Process Beer";
       NoLicenseCost = 1000;
	};
	
	class meth {
       MaterialsReq[] = {{"ephedra",2},{"lithium",2},{"phosphorus",2}};
